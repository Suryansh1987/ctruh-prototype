      ...
      <div className="rp-header">
        ...
        <a
          ...
          style={{
            ...
            padding: "5px 13px", transition: "all 180ms",
          }}
          ...
          onMouseLeave={e => { const el = e.currentTarget as HTMLAnchorElement; el.style.color = "rgba(255,255,255,0.4)"; el.style.background = "rgba(255,255,255,0.06)"; el.style.borderColor = "rgba(255,255,255,0.1)"; }}
        >
